					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:-5px">
						<tr>
							<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
								<div align="left" style="vertical-align: text-bottom"><font size="3" color="#FFF"><i class="fa fa-map-marker" aria-hidden="true"></i></font> <font size="3" color="#FFC107"><strong>Indicator Category</strong></font>
							</td>
							<td width="20%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
								<button type="button" id="modal_button" class="pull-right btn bg-deep-purple" data-toggle="modal" id="addItemModalBtn" data-target="#addItemModal"> <i class="fa fa-plus-square"></i> Add Indicator Category</button></div>
							</td>
						</tr>
					</table>
				</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="body">
								...
								<div class="col-md-12 form-input">
									<label><font color="#174082">Indicator Category: </font></label>
								...
								<div class="col-md-12 form-input">
									<label><font color="#174082">Indicator Category Description: </font></label>
								...
								<div class="div-result">
									<form class="form-horizontal" id="editItemForm" action="general-settings/action/project-indicator-category-action.php" method="POST">	
										...
										<div class="col-md-4 form-input">
											<label for="editStatus"><font color="#174082">Indicator Category Status: </font></label>
...
<!-- End Item Delete -->
<script src="general-settings/js/fetch-indicator-category.js"></script>