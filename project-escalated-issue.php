    ...
    try {
		...
		if ((isset($_POST["issueid"])) && !empty($_POST["issueid"])) {
			...
			elseif (isset($_POST["projstatuschange"]) && $_POST["projstatuschange"] == "Restore"){
				...
				$projid = $_POST["projid"];
				$comments = $_POST["comments"];
				$subject = "Project Parameters Adjusted";
				$user = $_POST["user_name"];
				...
				if($totalrows_userowner > 0 ){
					foreach($rows as $row){
						...
						$issuelink = '<a href="'.$url.'projectissuescomments?issue='.$encrypted_issue.'&owner='.$encrypted_created_by.'" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">More Details</a>';
														...
														<table class="table table-bordered table-striped table-hover">
															...
															while ($rows_project_members = $query_project_members->fetch()) { 	
																...
																<tr id="rowlines">
																	...
																	<?php if($available==0){ ?>
																		<td <?=$availclass?>><span class="mytooltip tooltip-effect-1"><span class="tooltip-item2"><?php echo $availability; ?></span><span class="tooltip-content4 clearfix" style="background-color:#CDDC39; color:#000"><span class="tooltip-text2"><h4 align="center"><u>Details</u></h4><strong>Unavailable From Date:</strong> <?php echo $leave_start_date; ?><br> <strong>In-Place:</strong> <?php echo $reassigneedto; ?><br> <strong>In-Place Phone:</strong> <?php echo $reassigneedphone; ?><br> <strong>In-Place Email:</strong> <?php echo $reassigneedemail; ?></span></span></span></td>
																	<?php }else{ ?>
