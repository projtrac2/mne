					...
					<div class="card">
						<div class="header" style="padding-bottom:0px">
                            <div class="button-demo" style="margin-top:-15px">
								<a href="#" class="btn bg-grey waves-effect" style="margin-top:10px; margin-left:4px">Settings</a>
								<a href="system-terminologies" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Terminologies</a>
								<a href="strategic-workplan-budget?plan=<?php echo $stplan; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Project Statuses</a>
								<a href="strategic-workplan-budget?plan=<?php echo $stplan; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Issue Statuses</a>
								<a href="strategic-workplan-budget?plan=<?php echo $stplan; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Financial Statuses</a>
