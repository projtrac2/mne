					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:-5px">
						<tr>
							<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
								<div align="left" style="vertical-align: text-bottom"><font size="3" color="#FFF"><i class="fa fa-list" aria-hidden="true"></i></font> <font size="3" color="#FFC107"><strong>Employee Leave Categories</strong></font>
							</td>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="body">
                                    ...
                                    <div class="col-md-12 form-input">
                                        <label><font color="#174082">Employee Leave Description: </font></label>
                            ...
                            <div class="body">
                                <div class="div-result">
                                    <form class="form-horizontal" id="editItemForm" action="general-settings/action/project-employee-leave-categories-action.php" method="POST">
                                        ...
                                        <div class="col-md-12 form-input">
                                            <label><font color="#174082">Employee Leave Category Description: </font></label>
