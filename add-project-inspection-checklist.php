                                        ...
                                        if ($totalRows_rsProjects > 0) {
                                            ...
                                            do {
                                                ...
                                                if ($filter_department) {
                                                    ...
                                                    $totalRows_rsMilestone == 0 ? "Add" : "Edit";
                                                    if ($sub_stage == 0) {
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    ?>
                                                                        <li>
                                                                            <a type="button" id="#finishAddItemModalBtn" href="add-project-output-inspection-checklist.php?projid=<?= $projid_hashed ?>" title="Click here to <?= $totalRows_rsMilestone == 0 ? "add" : "edit" ?> activities">
                                                                                <i class="fa fa-list"></i> <?= $activity ?> Activities
                                                                            </a>
                                                                        </li>
                                                                    <?php
                                                                    }
