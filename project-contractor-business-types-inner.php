    					...
    					<tr>
    						<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
    							<div align="left" style="vertical-align: text-bottom">
    								<font size="3" color="#FFC107"><i class="fa fa-cog" aria-hidden="true"></i> <strong>Project Contractor Business Types</strong></font>
    						</td>
    		...
    		<div class="table-responsive">
    			<table class="table table-bordered table-striped table-hover" id="manageItemTable">
    				<thead>
    					<tr>
    						<th width="3%">#</th>
    						<th width="20%">Contractor Business Type</th>
    						<th width="57%">Contractor Business Type Description</th>
    ...
    <div class="modal fade" id="addItemModal" tabindex="-1" role="dialog">
    	<div class="modal-dialog modal-lg">
    		<div class="modal-content">
    			<form class="form-horizontal" id="submitItemForm" action="general-settings/action/project-contractor-business-types-action.php" method="POST" enctype="multipart/form-data">
    				<?= csrf_token_html(); ?>
    				<div class="modal-header" style="background-color:#03A9F4">
    					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    					<h4 class="modal-title" style="color:#fff" align="center"><i class="fa fa-plus"></i> Add Contractor Business Type </h4>
    				</div>
    							...
    							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    								<div class="body">
    									...
    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Contractor Type: </font>
    										</label>
    										<input type="text" class="form-control" id="type" placeholder="Name of Contractor Type" name="type" required autocomplete="off">
    									</div> <!-- /form-group-->

    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Contractor Type Description: </font>
    										</label>
    										<textarea class="form-control" id="description" placeholder="Name of Contractor Business Type Description" name="description" required autocomplete="off"></textarea>
    									</div>
    									<!-- /form-group-->
    								</div>
    							</div>
    							...
    							<div class="body">
    								<div class="div-result">
    									<form class="form-horizontal" id="editItemForm" action="general-settings/action/project-contractor-business-types-action.php" method="POST">
    										...
    										<div class="col-md-12 form-input">
    											<label>
    												<font color="#174082">Contractor Business Type: </font>
    											</label>
    										...
    										<div class="col-md-12 form-input" style="margin-top:10px">
    											<label>
    												<font color="#174082">Contractor Business Type Description: </font>
    											</label>
    											<textarea class="form-control" id="editDescription" placeholder="Name of Contractor Business Type  Description" name="editDescription" required autocomplete="off" required></textarea>
    										</div> <!-- /form-group-->
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="removeItemModal">
    	<div class="modal-dialog">
    		<div class="modal-content">
    			...
    			<div class="modal-footer removeContractor Business TypeFooter">
    				<div class="col-md-12 text-center">
    ...
    <script src="general-settings/js/fetch-contractor-business-types.js"></script>