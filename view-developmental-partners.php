                            ...
                            <tr style="border-bottom:thin solid #EEE">
                                ...
                                <td align="center">
                                    <span class="badge bg-brown">
                                        <a href="view-financier-projects?fndid=<?php echo base64_encode($row_rsfinancier['id']); ?>" style="font-family:Verdana, Geneva, sans-serif; color:white; font-size:12px; padding-top:0px">
                                            <?php echo 0; ?>
                                        </a>
                                </td>
