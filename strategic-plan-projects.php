		...
		if (isset($_GET["adp"]) && isset($_GET["proj"]) && !empty($_GET["proj"])) {
			...
			if ($results) {
				...
				$results = "<script type=\"text/javascript\">
						...
						setTimeout(function(){
								window.location.href = 'strategic-plan-projects?plan=$splanid';
							}, 2000);
					</script>";
			}
		}
						...
						<div class="card-header">
							<div class="header" style="padding-bottom:0px">
								<div class="button-demo" style="margin-top:-15px">
									...
									<a href="view-objective-performance.php?plan=<?php echo $stplane; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px"><?= $planlabel ?> Progress Report</a>
								</div>
							</div>
						</div>
						<div class="body">
...
<script type="text/javascript">
	var url;
	url = "assets/processor/fetch-sp-projects?<?= (isset($_GET["prg"]) && !empty($_GET["prg"])) ? "prg=" . $progid . "&" : ""; ?>sp=<?= $stplan ?>";
</script>
