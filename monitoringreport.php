...
<body class="theme-blue" onload="getLocation()">
	...
	<!-- Inner Section -->
	<?php
	include_once('monitoringreport-inner.php');
	?>
	<!-- #END# Inner Section -->
