...
if ($permission) {
    ...
    try {
        ...
        $query_rsProjects = $db->prepare("SELECT * FROM tbl_projects WHERE deleted='0' and projmapping=1 and projstage = 6");
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($totalRows_rsProjects > 0) {
                                                        ...
                                                        do { //projects loops
                                                            ...
                                                            $query_rslocations = $db->prepare("SELECT * FROM `tbl_output_disaggregation` where projid=:projid");
                                                            $query_rslocations->execute(array(":projid" => $projid));
                                                            $row_rslocations = $query_rslocations->fetch();
                                                            $totalRows_rslocations = $query_rslocations->rowCount();


                                                            if ($totalRows_rslocations > 0) {
                                                                // members 
                                                    ...
                                                    ?>
                                                                        ...
                                                                        do {
                                                                            ...
                                                                            $row_rsIndicator = $query_rsIndicator->fetch();
                                                                            $totalRows_rsIndicator = $query_rsIndicator->rowCount();
                                                                            $projwaypoints = $row_rsIndicator ? $row_rsIndicator['indicator_mapping_type'] : "";
                                                                        ...
                                                                        ?>
                                                                            <tr class="collapse project<?php echo $projid ?>" style="background-color:#e9e9e9">
                                                                                ...
                                                                                <td><?= $totalRows_rsMapping ? $row_rsMapping['type'] : "" ?></td>
                                                                                <td>
                                                                                    <div class="btn-group">
                                                                                            ...
                                                                                            ?>
                                                                                                    <li>
                                                                                                        <a type="button" data-toggle="modal" data-target="#addFormModal" id="addFormModalBtn" onclick="edit(<?php echo $projid . ',' . $outputid . ',' . $dissagragated ?>)">
                                                                                                            <i class="fa fa-pencil-square"></i> </i> Reassign
                                                                                                        </a>
                                                                                                    </li>
                                                                                                <?php
                                                                                                }
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($map_rsMap > 0) {
                                                        ...
                                                        do {
                                                            ...
                                                            $query_rsIndicator =  $db->prepare("SELECT indicator_disaggregation, indicator_mapping_type FROM tbl_indicator WHERE indid=:indicator");
                                                            $query_rsIndicator->execute(array(":indicator" => $indicator));
                                                            $row_rsIndicator = $query_rsIndicator->fetch();
                                                            $totalRows_rsIndicator = $query_rsIndicator->rowCount();
                                                            $disaggregation = $row_rsIndicator['indicator_disaggregation'];
                                                            $mapping_type = $row_rsIndicator['indicator_mapping_type'];
