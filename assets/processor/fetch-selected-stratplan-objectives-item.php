        ...
        <div class="card"> 
            ...
            <div class="row clearfix"> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="">
					...
					<div class="form-line">
						<input name="kpi" type="text" class="form-control" style="width:100%; border:#CCC thin solid; border-radius: 5px" value="'.$KPI.'" readonly>  
					</div>
				</div> 
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" align="">
					<label class="control-label">KPI Unit of Measure : </label>
					<div class="form-line">
						<input name="kpi" type="text" class="form-control" style="width:100%; border:#CCC thin solid; border-radius: 5px" value="'.$unit.'" readonly>  
					</div>
				</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="">
							...
							<tbody id="financier_table_body">
								<tr>';
									for ($j = 0; $j < $years; $j++) {
										...
										$query_yrtarget->execute(array(":objid" => $itemId, ":styear" => $styear));
										$row_yrtarget = $query_yrtarget->fetch(); 
										$yrtarget =$row_yrtarget['target']; 
										
										$input .= '<td>
											<input type="text" name="target" class="form-control" value="'.$yrtarget.' '.$unit.'" style="width:100%; border:#CCC thin solid; border-radius: 5px" readonly>
										</td>';
										$styear++;
									} 
								$input .= '</tr>
								<tr>';
									...
									for ($k = 0; $k < $years; $k++) {
										...
										$query_targthreshold->execute(array(":objid" => $itemId, ":styear" => $stryear));
										...
										$input .= '<td align="center">
											...
											while($row_targthreshold = $query_targthreshold->fetch()){
												...
												$input .= '<input data-type="RAG" type="text" name="thresholdy[]" class="form-control" value="'.$targthreshold.'" style="width:24%; margin-left:3px; border:#CCC thin solid; border-radius: 5px; float:left"  readonly> ';
											}
										$input .= '</td>';
										$stryear++;
									} 
