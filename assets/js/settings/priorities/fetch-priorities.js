...
$(document).ready(function () {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "ajax/settings/priorities/fetch-selected-priorities-items.php",
    order: [],
    'columnDefs': [{
      'targets': [5],
      'orderable': false,
  ...
  $("#submitItemForm").on("submit", function (event) {
    ...
    if (weight && priority && description) {
      ...
      var formData = new FormData(this);
        // ajax/settings/priorities/project-priorities-action.php
      $.ajax({
        url: "ajax/settings/priorities/project-priorities-action.php",
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "ajax/settings/priorities/fetch-selected-priorities-item.php",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function (response) {
