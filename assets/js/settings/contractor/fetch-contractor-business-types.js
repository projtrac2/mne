...
$(document).ready(function() {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "ajax/settings/contractor/fetch-selected-contractor-business-types-items.php",
    order: [], 
    'columnDefs': [{
      'targets': [4],
      'orderable': false,
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "ajax/settings/contractor/fetch-selected-contractor-business-types-item.php",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function(response) {
...
function disable(id, name, action) {
  swal({
    ...
    if (willUpdate) {
      $.ajax({
        type: "post",
        url: 'ajax/settings/contractor/project-contractor-business-types-action.php',
        data: {
