...
$(document).ready(function() {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "ajax/settings/map-types/fetch-selected-map-type-items.php",
    order: [], 
    'columnDefs': [{
      'targets': [5],
      'orderable': false,
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "ajax/settings/map-types/fetch-selected-map-type-item.php",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function(response) {
        ...
        $("#editItemForm")
          ...
          .bind("submit", function() {
            ...
            if (type && description) {
              ...
              $.ajax({
                url: "ajax/settings/map-types/project-map-type-action.php",
                type: form.attr("method"),
                data: formData,
                cache: false,
                contentType: false,
