<?php
$objid = (isset($_GET['obj'])) ? base64_decode($_GET['obj']) : header("Location: view-strategic-plans.php");
$pageName = "EDIT STRATEGIC OBJECTIVE DETAILS";
$Id = 2;
$subId = 5;
...
try {
    ...
    $stplan = base64_encode($result_kra['spid']);
