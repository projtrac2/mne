    					...
    					<tr>
    						<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
    							<div align="left" style="vertical-align: text-bottom">
    								<font size="3" color="#FFF"><i class="fa fa-flag" aria-hidden="true"></i></font>
    								<font size="3" color="#FFC107"><strong>Project Contractor Nationality</strong></font>
    						</td>
    ...
    <div class="modal fade" id="addItemModal" tabindex="-1" role="dialog">
    	<div class="modal-dialog modal-lg">
    		<div class="modal-content">
    			<form class="form-horizontal" id="submitItemForm" action="general-settings/action/project-contractor-nationality-action.php" method="POST" enctype="multipart/form-data">
    				<?= csrf_token_html(); ?>
    				<div class="modal-header" style="background-color:#03A9F4">
    					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    					<h4 class="modal-title" style="color:#fff" align="center"><i class="fa fa-plus"></i> Add Contractor Nationality </h4>
    				</div>
    							...
    							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    								<div class="body">
    									...
    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Contractor Nationality: </font>
    										</label>
    										<input type="text" class="form-control" id="nationality" placeholder="Name of Contractor Nationality" name="nationality" required autocomplete="off">
    									</div> <!-- /form-group-->

    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Contractor Nationality Description: </font>
    										</label>
    										<textarea class="form-control" id="description" placeholder="Name of Contractor Nationality Description" name="description" required autocomplete="off"></textarea>
    									</div>
    									<!-- /form-group-->
    								</div>
    							</div>
    ...
    <div class="modal fade" id="editItemModal" tabindex="-1" role="dialog">
    	<div class="modal-dialog modal-lg">
    		<div class="modal-content">
    			<div class="modal-header" style="background-color:#03A9F4">
    				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    				<h4 class="modal-title" style="color:#fff" align="center"><i class="fa fa-edit"></i> Edit Contractor Nationality</h4>
    			</div>
    								...
    								<div class="div-result">
    									<form class="form-horizontal" id="editItemForm" action="general-settings/action/project-contractor-nationality-action.php" method="POST">
    										...
    										<div class="col-md-12 form-input" style="margin-top:10px">
    											...
    											<textarea class="form-control" id="editDescription" placeholder="Name of Contractor Nationality  Description" name="editDescription" required autocomplete="off" required></textarea>
    										</div> <!-- /form-group-->
    ...
    <script src="general-settings/js/fetch-contractor-nationality.js"></script>