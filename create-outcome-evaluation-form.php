...
try{
	...
	//department
	$query_rsDept = $db->prepare("SELECT stid, sector FROM tbl_sectors s INNER JOIN tbl_programs g ON g.projdept=s.stid INNER JOIN tbl_projects p ON p.progid=g.progid WHERE p.projid='$projid'");
							...
							<div class="wizard">
								<div class="wizard-inner" style="margin-top:-20px">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class="disabled">
											<a href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Form & Section Details">
												<span class="round-tab">
													FORM DETAILS
												</span>
											</a>
										...
										<li role="presentation" class="disabled">
											<a href="#step4" data-toggle="tab" aria-controls="step4" role="tab" title="Form Questions ">
												<span class="round-tab">
													QUESTIONS
												</span>
											</a>
								...
								<div class="tab-content">
										...
										<fieldset class="scheduler-border">
											...
											<div class="row clearfix">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="col-md-12">
														<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
															<thead>
																<tr class="bg-light-blue">
																	<th style="width:3%">#</th>
																	<th style="width:15%">Project Issue</th>
																	<th style="width:15%">Risk Category</th>
															...
															<tbody>
																...
																<tr>
																	...
																	<td <?php echo $style; ?>><?php echo $score; ?></td>
													...
													<div class="col-md-12">
														<label class="control-label">Action Comments:</label>
														<div class="form-line">
															<div style="border:#CCC thin solid; border-radius:5px; height:40px; padding:10px; color:#3F51B5">
																<strong><?php echo $evaluatereason; ?></strong>
															</div>
														</div>
													</div>
													<div class="col-md-12">
														<ul class="list-inline pull-right" style="margin-top:20px">
															<li><button type="button" class="btn btn-default prev-step">Previous</button> <button type="button" class="btn btn-primary next-step" id="issues">Continue</button></li>
														</ul>
													</div>
												</div>
											</div>
									...
									<div class="tab-pane" role="tabpanel" id="step3">
										<form action="" method="POST" role="form" id="formone">
											<fieldset class="scheduler-border">
												...
												<!--<div class="col-md-12">
													<label class="control-label">Correspondents' Email Address(es)*:</label>
													<div class="form-line">
														<input type="text" name="correspondents[]" id="correspondents" class="form-control" placeholder="Enter evaluation form Correspondents' Email Address(es) seperated by comma(,)" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required>
													</div>
												</div>--
												<div class="col-md-12 email-id-row">
													<span class="to-input">Correspondents' Email Address(es)*:</span>
													<div class="all-mail">

													</div>
													<input type="email" name="mail" class=" form-control enter-mail-id" placeholder="Enter the email id .." />
												</div>-->
												<div class="col-md-4">
													<div class="form-group">
									...
									<div class="tab-pane" role="tabpanel" id="complete">
										<fieldset class="scheduler-border">
											...
											<p style="color:green"><strong>You have successfully created your evaluation form.</strong></p>
