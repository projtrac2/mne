...
try{	
	...
	if(isset($_GET['btn_csv']) && $_GET['btn_csv']=="CSV"){
		...
		if(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){			
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){	
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' ORDER BY p.projsector ASC
			");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){			
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){			
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projsector = '$psector_rsUpP'  ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && !empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projdepartment = '$pdept_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' AND p.projstatus ='$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projdepartment = '$pdept_rsUpP' AND p.projstatus ='$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projcommunity = '$pcomm_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projsector = '$psector_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projlga = '$pstate_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' AND p.projlga = '$pstate_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projcommunity = '$pcomm_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projlga = '$pstate_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && !empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projstatus = '$pstatus_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
	...
	if (isset($_GET['srcfyear']) || isset($_GET['srcsct']) || isset($_GET['srcdept']) || isset($_GET['srccomm']) || isset($_GET['srcstate']) || isset($_GET['srcstatus']) || isset($_GET['srctype'])){
		...
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && !empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projsector = '$psector_rsUpP' AND p.projdepartment = '$pdept_rsUpP' ORDER BY p.projsector ASC");
		}
		...
		elseif(empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			...
			$query_rsUpP = sprintf("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' ORDER BY p.projsector ASC");
				$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && !empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projsector = '$psector_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' AND p.projlga = '$pstate_rsUpP' ORDER BY p.projsector ASC");
		...
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && !empty($pcomm_rsUpP) && empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projcommunity = '$pcomm_rsUpP' ORDER BY p.projsector ASC");
		}
		elseif(!empty($pfscyr_rsUpP) && empty($psector_rsUpP) && empty($pdept_rsUpP) && empty($pcomm_rsUpP) && !empty($pstate_rsUpP) && empty($pstatus_rsUpP)){
			$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' AND p.projfscyear = '$pfscyr_rsUpP' AND p.projlga = '$pstate_rsUpP' ORDER BY p.projsector ASC");
		}
	}
	else{
		$query_rsUpP =  $db->prepare("SELECT p.*, p.projname AS name, p.projsector AS SCT, p.projcost AS pcost, p.projstartdate AS stdate, p.projenddate AS endate, @curRow := @curRow + 1 AS sn FROM tbl_projects p JOIN (SELECT @curRow := 0) r WHERE p.deleted ='0' ORDER BY p.projsector ASC");
	...
	$query_rsSector =  $db->prepare("SELECT DISTINCT projsector FROM tbl_projects WHERE projsector IS NOT NULL ORDER BY projsector DESC");
	$query_rsSector->execute();		
	$row_rsSector = $query_rsSector->fetch();
	$totalRows_rsSector = $query_rsSector->rowCount();
	
	$query_rsDept =  $db->prepare("SELECT DISTINCT projdepartment FROM tbl_projects WHERE projdepartment IS NOT NULL ORDER BY projdepartment DESC");
	...
	$query_rsComm =  $db->prepare("SELECT id, state FROM tbl_projects p inner join tbl_state s on s.id=p.projcommunity GROUP BY p.projcommunity ORDER BY s.state ASC");
	$query_rsComm->execute();		
	$row_rsComm = $query_rsComm->fetch();
	$totalRows_rsComm = $query_rsComm->rowCount();
	
	$query_rsState =  $db->prepare("SELECT id, state FROM tbl_projects p inner join tbl_state s on s.id=p.projlga GROUP BY p.projlga ORDER BY s.state ASC");
...
<body class="theme-blue">
    ...
    <section class="content" style="margin-top:-20px; padding-bottom:0px">
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="header">
                            <div class="button-demo">
                                ...
                                <a href="#" class="btn bg-grey waves-effect" style="margin-top:10px">Financial Report</a>
            ...
            <!-- Exportable Table -->
			<?php  include_once('projfundingreport-insider.php');?>
