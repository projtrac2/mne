...
?>
	<div class="container-fluid">
		<div class="block-header bg-blue-grey" width="100%" height="55" style="margin-top:10px; padding-top:5px; padding-bottom:5px; padding-left:15px; color:#FFF">
			<h4 class="contentheader"><i class="fa fa-newspaper-o" aria-hidden="true"></i> OUTPUT INDICATORS QUARTERLY PROGRESS REPORT
			</h4>
		</div>
		<!-- Draggable Handles -->
													...
													<tbody>
														...
														if ($totalRows_indicators > 0) {
															while ($row_indicators = $query_indicators->fetch()) {
																...
																$query_indbasevalue_year->execute(array(":indid" => $indid, ":finyear" => $fyid));
																...
																if ($totalRows_indbasevalue_year >= 0) {
																	...
																	$query_quarter_two_actual = $db->prepare("SELECT SUM(actualoutput) AS achieved FROM tbl_monitoringoutput m inner join tbl_project_details d on d.id=m.opid WHERE indicator=:indid AND (date_created>=:startq2 AND date_created<=:endq2)");
																	...
																	$query_quarter_four_actual = $db->prepare("SELECT SUM(actualoutput) AS achieved FROM tbl_monitoringoutput m inner join tbl_project_details d on d.id=m.opid WHERE indicator=:indid AND (date_created>=:startq4 AND date_created<=:endq4)");
