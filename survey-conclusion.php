											  ...
											  $row_variable = $query_variables->fetchAll(); */
														...
														$variableid = $row_variables["id"]; */
														  ...
														  if ($type == "n") { */
															  ...
															  <label class="control-label"><? //= $variable
																							?> (<? //= $disaggregations["disaggregation"]
																								?>):</label>
															  <div class="form-line">
																<input name="numerator<? //= $locations
																						?>[]" type="text" class="form-control" placeholder="Enter numerator value" style="border:#CCC thin solid; border-radius: 5px" value="<? //=$count_loc_yes_answers
																																																								?>" required />
															  </div>
															</div>-->
																			<?php
															  ...
															  <label class="control-label"><? //= $variable
																							?> (<? //= $disaggregations["disaggregation"]
																								?>):</label>
															  <div class="form-line">
																<input name="denominator<? //= $locations
																						?>[]" type="text" class="form-control" placeholder="Enter denominator value" value="<? //=$count_loc_total_answers
																																											?>" style="border:#CCC thin solid; border-radius: 5px" required />
															  </div>
															</div>-->
																			<?php
																			/* }
														  ...
														  if ($type == "n") { */
															  ...
															  <div class="form-line">
																<input name="numerator<? //= $locations
																						?>[]" type="text" class="form-control" placeholder="Enter value" value="<? //=$count_loc_yes_answers
																																								?>" style="border:#CCC thin solid; border-radius: 5px" required />
															  </div>
															</div>-->
																			<?php
													  ...
													  if ($category == 2) {
														...
														if ($type == "n") { */
															...
															<div class="form-line">
															  <input name="numerator<? //= $locations
																					?>" type="text" class="form-control" placeholder="Enter value" style="border:#CCC thin solid; border-radius: 5px" required />
															</div>
														  </div>-->
																		<?php
																		/* }
