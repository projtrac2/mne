...
try {
	...
	// get adps
	$query_adps =  $db->prepare("SELECT * FROM tbl_annual_dev_plan d inner join tbl_fiscal_year y on y.id=d.financial_year inner join tbl_projects p ON p.projid=d.projid WHERE d.status = 1 ORDER BY d.id ASC");
	$query_adps->execute();
...
<body class="theme-blue">
	...
	<section class="content" style="margin-top:-20px; padding-bottom:0px">
		<div class="container-fluid">
			<!-- <div class="body"> -->
			<?php
			include_once('approved-projects-inner.php');
			?>
			<!--</div> -->
		</div>
	</section>
