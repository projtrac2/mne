...
$pageTitle = "Add Project Procurement Details";
...
if ($permission) {
	...
	try {
		...
		$query_rsProjects = $db->prepare("SELECT g.progid, g.progname, g.projsector, p.projcode, p.projid, p.projname, p.projinspection, s.sector FROM tbl_projects p inner join tbl_programs g on g.progid=p.progid inner join tbl_sectors s on s.stid=g.projdept WHERE p.deleted='0' and p.projstage=6");
														...
														if ($totalRows_rsprojtenderdetails == 0) { ?>
															<div class="btn-group">
																...
																<ul class="dropdown-menu">
																	...
																	?>
																		<li>
																			<a type="button" href="edit-financial-plan?prj=<?= $hash ?>" id="addFormModalBtn">
																				<i class="fa fa-pencil-square"></i> </i> Edit Plan
																			</a>
																		</li>
																		<li>
																			<a type="button" data-toggle="modal" data-target="#removeItemModal" id="#removeItemModalBtn" onclick="removeItem(<?php echo $row_rsProjects['projid'] ?>, 2)">
														...
														?>
															<div class="btn-group">
																...
																<ul class="dropdown-menu">
																	...
																	?>
																		<li>
																			<a type="button" href="edit-procurement-details?prj=<?= $hash ?>" id="addFormModalBtn">
																				<i class="fa fa-pencil-square"></i> </i> Edit Procurement
																			</a>
																		</li>
																		<li>
																			<a type="button" data-toggle="modal" data-target="#removeItemModal" id="#removeItemModalBtn" onclick="remove_procurement(<?php echo $row_rsProjects['projid'] ?>, 2)">
																				<i class="fa fa-trash-o"></i> Delete Procurement
																			</a>
																		</li>
																	<?php
																	}
