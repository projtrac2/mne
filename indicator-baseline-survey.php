	...
	function closesurvey(formid = null) {
	  if (formid) {
		...
		$.ajax({
		  ...
		  type: "post",
		  data: { formid: formid, username: username },
		  dataType: "html",
...
<body class="theme-blue">
    ...
    <section class="content" style="margin-top:-20px; padding-bottom:0px">
        <div class="container-fluid">
            <div class="block-header" width="100%" height="55" style="margin-top:10px; padding-top:5px; padding-bottom:5px; padding-left:15px; background-color:blue-grey; color:#FFF">
				<h4 class="contentheader"><i class="fa fa-list-ol" aria-hidden="true"></i> Project Evaluation
				</h4>
            </div>
            <!-- Draggable Handles -->
            <div class="row clearfix">
				<div class="block-header" id="processingid">
					<?php 
					echo $results;
					?>
				</div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <!-- <div class="body"> -->
							<?php
							include_once('indicator-baseline-survey-inner.php');
							?>
						<!--</div> -->
                    </div>
                </div>
