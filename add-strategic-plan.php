    ...
    try {
        ...
        if (isset($_POST['addplan'])) {
            if (validate_csrf_token($_POST['csrf_token'])) {
                ...
                $resultstrplan = $strplanInsert->execute(array(":plan" => $strategicplan, ":vision" => $vision, ":mission" => $mission, ":years" => $years, ":styear" => $styear, ":user" => $user_name, ":dates" => $current_date));
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="card" style="margin-bottom:-20px">
                                                    ...
                                                    <div class="body">
                                                        ...
                                                        <input name="end_year" type="hidden" id="end_year" value="<?= get_end_year() ?>" />
