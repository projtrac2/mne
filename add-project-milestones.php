                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        ?>
                                                                            <li>
                                                                                <a type="button" id="#finishAddItemModalBtn" href="add-milestone.php?projid=<?= $projid_hashed ?>" title="Click here to <?= $totalRows_rsMilestone == 0 ? "add" : "edit" ?> activities">
                                                                                    <i class="fa fa-list"></i> <?= $activity ?> Milestones
                                                                                </a>
                                                                            </li>
                                                                        <?php
                                                                        }
