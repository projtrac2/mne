																	...
																	<table class="table table-bordered table-striped table-hover js-basic-example dataTable" style="width:100%">
																		...
																		<tbody>
																			...
																			while ($row_mbrprojs = $query_mbrprojs->fetch()) {
																				...
																				$query_projroles =  $db->prepare("SELECT r.id, r.rank, r.role FROM tbl_projmembers m inner join tbl_project_team_roles r on r.id=m.role WHERE ptid='$user_name' and projid='$projid'");
