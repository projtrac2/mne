...
try {
	...
	if (isset($_POST['issue_type'])) {
		...
		if ($issue_type == 2) {
			...
			$issuefileds = '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="adjust_scope" style="margin-bottom:10px">';
			...
			if ($rows_sites > 0) {
				...
				while ($row_Sites = $query_Sites->fetch()) {
					...
					$issuefileds .= '<fieldset class="scheduler-border">
							<legend class="scheduler-border" style="background-color:#c7e1e8; border-radius:3px">
								SITE ' . $counter . ':' . $site . '
							</legend>';
			...
			$issuefileds = '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="adjust_schedule" style="margin-bottom:10px">';
			...
			$issuefileds = '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="adjust_cost" style="margin-bottom:10px">';
		...
		echo json_encode(array('success' => $success, 'issuefileds' => $issuefileds));
	}
