											...
											<tbody>
												...
												if ($total_rsPayement_reuests > 0) {
													...
													do {
														...
														$total_amount = $rows_rsPayement_reuests['amount_requested'];
																...
																<td>
																	...
																	<div class="btn-group">
																		...
																		<ul class="dropdown-menu">
																			<li>
																				<a type="button" id="addmoneval" data-toggle="modal" id="disburseItemModalBtn" data-target="#disburseItemModal">
								...
								<div id="menu1" class="tab-pane">
									...
									<div class="table-responsive">
										<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
											...
											<tbody>
												<?php
												$query_rsPayement_reuests =  $db->prepare("SELECT * FROM tbl_payments_request r INNER JOIN tbl_payments_disbursed d ON d.request_id = r.request_id WHERE status = 3");
												$query_rsPayement_reuests->execute();
												$rows_rsPayement_reuests = $query_rsPayement_reuests->fetch();
												$total_rsPayement_reuests = $query_rsPayement_reuests->rowCount();
												if ($total_rsPayement_reuests > 0) {
													...
													do {
														$costline_id = $rows_rsPayement_reuests['id'];
														$projid = $rows_rsPayement_reuests['projid'];
														$amount_paid = $rows_rsPayement_reuests['amount_requested'];
			...
			<div class="modal-content">
				...
				<form class="form-horizontal" id="modal_form_submit" action="" method="POST" enctype="multipart/form-data">
					<div class="modal-body" id="">
						<!-- /modal-body -->
						<div id="budget_line_more_details">
						</div>
