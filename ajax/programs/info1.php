    ...
    if ($rows_count > 0) {
        ...
        if ($total_outputIndicator > 0) {
            while ($row_outputIndicator = $query_outputIndicator->fetch()) {
                ...
                $output_table_body .= '<tr> <td>' . $indicator_name . '</td> <td>' . $output . '</td>';
        ...
        if ($program_type == 1) {
            ...
            if ($row_outputdetails > 0) {
                ...
                while ($row_outputdetails = $query_outputdetails->fetch()) {
                    ...
                    $quarterly_targets_table_body  .= '<tr><td>' . $output . ' (' . $program_start_year . ') </td>';
                    for ($j = 0; $j < $progYears; $j++) {
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="body" style="margin-top:5px; margin-bottom:5px">
                                ...
                                ' . $strategic_plan_div . '
                                <div class="row"> 
                                    <div class="col-md-4"><strong><font color="#9C27B0">Problem Statement: </font></strong>' . $program_problem_statement . '</div>
                                    <div class="col-md-4"><strong><font color="#9C27B0">Start Year: </font></strong>' . $progStartingYear . '/' . $sfinyear . '</div>
                                    <div class="col-md-4"><strong><font color="#9C27B0">End Year: </font></strong>' . $progendingYear . '/' . $endfinyear . '</div>
                                    <div class="col-md-4"><strong><font color="#9C27B0">Duration: </font></strong>' . $progYears . ' Year(s)</div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-4"><strong><font color="#9C27B0">' . $ministrylabel . ': </font></strong>' . $program_department . ' </div> 
                                    <div class="col-md-8"><strong><font color="#9C27B0">' . $departmentlabel . ': </font></strong>' . $program_section . ' </div>
                                    <div class="col-md-8"><strong><font color="#9C27B0">' . $directoratelabel . ': </font></strong>' . $program_directorate . ' </div>
                                </div> 
                                <div class="row">
