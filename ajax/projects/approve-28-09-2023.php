   ...
   if ($totalRows_rsProjects > 0) {
      ...
      $budget_name = '
         ...
         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="form-line">
               <input type="text"  name="projapprovedbudget" onchange="approved_budget()" onkeyup="approved_budget()" value="" id="projapprovedbudget" placeholder="' . $project_initial_budget . '" class="form-control" class="form-control" ' . $project_budget_deplecated . ' required/>
