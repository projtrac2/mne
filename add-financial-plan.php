...
if ($permission) {
	...
	try {
		...
		$query_rsProjects = $db->prepare("SELECT * FROM tbl_projects WHERE deleted='0' and projstage=5 and projid = :projid");
									...
									<fieldset class="scheduler-border">
										...
										do {
											...
											$summary  .= '<tr>
																...
																<td id="summaryOutput' . $outputid . '" ></td>
																<td id="perc' . $outputid .  '" ></td>
															</tr>';
										?>
																	...
																	<table class="table table-bordered" id="direct_table<?= $outputid ?>">
																			...
																			?>
																						...
																						?>
																							...
																							<tr class="task<?= $taskid ?>">
																								...
																								<td>
																									<input type="text" name="ddescription<?= $taskid ?>[]" id="dddescription<?= $taskid ?>1" class="form-control" placeholder="Item Descritpion" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required>
																								</td>
																								<td>
																									<input type="text" name="dunit<?= $taskid ?>[]" id="dunit<?= $taskid ?>1" class="form-control" placeholder="Unit" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required>
																								</td>
																								<td>
																									<input type="hidden" name="hunitcost<?= $taskid ?>[]" id="dhunitcost<?= $taskid ?>1">
																									<input type="number" name="dunitcost<?= $taskid ?>[]" id="dunitcost<?= $taskid ?>1" onchange="number_of_units_change(<?= $tkid ?>, <?= $outputid ?>,1,1)" onkeyup="number_of_units_change(<?= $tkid ?>, <?= $outputid ?>,1,1)" class="form-control" placeholder="Unit Cost" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required>
																								</td>
																								<td>
																									<input type="hidden" name="htotalunits<?= $taskid ?>[]" id="dhtotalunits<?= $taskid ?>1">
																									<input type="number" name="dtotalunits<?= $taskid ?>[]" id="dtotalunits<?= $taskid ?>1" onkeyup="totalCost(<?= $tkid ?>, <?= $outputid ?>,1, 1)" onchange="totalCost(<?= $tkid ?>, <?= $outputid ?>,1,1)" class="form-control" placeholder="No of Units" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required>
																								</td>
																								<td>
																									<input type="hidden" name="htotalcost<?= $taskid ?>[]" id="dhtotalcost<?= $taskid ?>1">
																									<input type="text" name="dtotalcost<?= $taskid ?>[]" id="dtotalcost<?= $taskid ?>1" class="form-control totalCost summarytotal  output_cost<?= $outputid ?> direct_sub_total_amount1<?= $outputid ?>" placeholder="Total Cost" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" required disabled>
																								</td>
																								<td>
																		...
																		<tfoot>
																			<tr>
																				...
																				<td colspan="1">
																					<input type="text" name="d_sub_total_amount" id="sub_total_amount1<?= $outputid ?>" class="form-control" placeholder="Total sub-total" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																				</td>
																				<td colspan="1"> <strong>% Sub Total</strong></td>
																				<td colspan="1">
																					<input type="text" name="d_sub_total_percentage" id="sub_total_percentage1<?= $outputid ?>" class="form-control" placeholder="% sub-total" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																				</td>
																				<td colspan="1"> <strong>Output Budget Bal</strong></td>
																				<td colspan="2">
																					<input type="text" name="outputBal" id="" class="form-control output_cost_bal<?= $outputid ?>" value="<?= number_format($outputCost, 2) ?>" placeholder="" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																				</td>
																			</tr>
																		</tfoot>
																		</tbody>
																	...
																	<table class="table table-bordered">
																		...
																		<tfoot id="pfoot<?= $outputid ?>">
																			<tr>
																				...
																				<td colspan="1">
																					<input type="text" name="d_sub_total_amount" id="sub_total_amount2<?= $outputid ?>" class="form-control" placeholder="Total sub-total" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																				</td>
																				<td colspan="2">
																					<strong style="height:35px; width:50%; float:left">% Sub-Total</strong>
																					<input type="text" name="d_sub_total_percentage" id="sub_total_percentage2<?= $outputid ?>" class="form-control" placeholder="% sub-total" style="height:35px; width:50%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif; float:left" disabled>
																				</td>
																			</tr>
																			<tr>
																			...
																			<table class="table table-bordered">
																				...
																				<tfoot id="budget_line_foot<?= $budget_lineid ?>">
																					<tr>
																						<td colspan="1"><strong>Sub Total</strong></td>
																						<td colspan="2">
																							<input type="text" name="subtotal_amount3<?= $budget_lineid ?>" id="sub_total_amount3<?= $budget_lineid ?>" class="form-control" placeholder="Total sub-total" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																						</td>
																						<td colspan="1"> <strong>% Sub Total</strong></td>
																						<td colspan="1">
																							<input type="text" name="subtotal_percentage3<?= $budget_lineid ?>" id="sub_total_percentage3<?= $budget_lineid  ?>" class="form-control" placeholder="% sub-total" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
																						</td>
																						<td colspan="1"> <strong>Output Budget Bal</strong></td>
																						<td colspan="2">
																							<input type="text" name="outputBal" id="" class="form-control output_cost_bal<?= $outputid ?>" value="<?= number_format($outputCost, 2) ?>" placeholder="" style="height:35px; width:99%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" disabled>
												...
												<div class="col-md-6" id="responsible_div">
													...
													<div class="form-line">
														<select name="responsible" id="responsible" class="form-control show-tick" style="border:1px #CCC thin solid; border-radius:5px" data-live-search="true" required="required">
															<option value="">.... Select from list ....</option>
															<?php
															$query_reportUser =  $db->prepare("SELECT t.* FROM tbl_projmembers m inner join tbl_projteam2 t on t.ptid=m.ptid where m.projid = :projid");
