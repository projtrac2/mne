                           ...
                           <div class="row clearfix">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <ul class="list-group">
                                    ...
                                    <li class="list-group-item"><strong>Total Project Cost: </strong> Ksh. <?php echo number_format($projcost, 2); ?> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<strong>Direct Cost: </strong> Ksh. <?= number_format($direct_cost, 2) ?> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                       <?php
                                       if ($administrative_cost > 0) {
                                       ?>
                                          <strong>Administrative Cost: </strong> Ksh. <?= number_format($administrative_cost, 2) ?>
                                       <?php
                                       }
                                       ?>
                                    </li>
