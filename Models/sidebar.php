...
<div class="menu">
    <div class="span2 sidemenu">
        <ul id="accordion" class="accordion">
            ...
            $sidebar_sql = $db->prepare("SELECT p.id, p.url,p.name,p.icon FROM tbl_pages p INNER JOIN tbl_page_designations d ON p.id = d.page_id WHERE status=1 AND parent=0 and d.designation_id=:designation_id ORDER BY p.priority ASC");
