<?php
	...
	try {
		...
		$mail = new PHPMailer;
		$subject = "Project Scheduler Test";
		$body = '<!doctype html>
		<html>
		  <head>
						...
						<td class="wrapper">
						  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
							<tr>
							  <td>
								<p>Dear Kitheka,</p>
								<p>You have been assigned a project milestone to inspection, please make the necessary arrangement and do the inspection by Evans</p>
								<p>ASSIGNMNE COMMENTS</p>
									...
									<tr>
									  <td align="left">
										<table role="presentation" border="0" cellpadding="0" cellspacing="0">
										  <tbody>
											<tr>
											  <td> <a href="http://104.197.153.188/softme/milestoneinspection" target="_blank">Check the assignment</a> </td>
											</tr>
										  </tbody>
										</table>
									  </td>
		...
		$mail->addAddress('biwottech@gmail.com', 'Evans Kipkoech');     // Add a recipient
