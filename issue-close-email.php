...
<p>This is to notify you that the issue with the details below has been closed </p><P>Issue: '.$issue.'. <br> Project Name: '.$project.' <br> Issue Severity: '.$severity.' <br> Date Closed: '.$emaildate.'</p>
