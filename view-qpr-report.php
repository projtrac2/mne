											...
											<div class="row clearfix">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																if ($totalRows_indicators > 0) {
																	...
																	while ($row_indicators = $query_indicators->fetch()) {
																		...
																		if ($totalRows_indbasevalue_year >= 0) {
																			...
																			$query_actual_ind_value = $db->prepare("SELECT SUM(achieved) AS basevalue FROM tbl_monitoringoutput m inner join tbl_project_details d on d.id=m.output_id WHERE m.record_type=1 AND d.indicator=:indid AND m.date_created <= '" . $basedate . "'");
													...
													<div class="col-md-12">
														...
														<p align="left">
															<textarea name="challenges" cols="45" rows="5" class="txtboxes" id="challenges" required="required" style="height:50px; width:98%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" placeholder="." <?= ($responsible) ? '' : 'disabled' ?>><?= ($totalRows_rsConclusion > 0) ? $Rows_rsConclusion['challenges'] : "";  ?></textarea>
															<script>
													...
													<div class="col-md-12">
														...
														<p align="left">
															<textarea name="conclusion" cols="45" rows="5" class="txtboxes" id="conclusion" required="required" style="height:50px; width:98%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" placeholder="" <?= ($responsible) ? '' : 'disabled' ?>><?= ($totalRows_rsConclusion > 0) ? $Rows_rsConclusion['conclusion'] : "";  ?></textarea>
															<script>
													...
													<div class="col-md-12">
														...
														<p align="left">
															<textarea name="appendice" cols="45" rows="5" class="txtboxes" id="appendice" required="required" style="height:50px; width:98%; color:#000; font-size:12px; font-family:Verdana, Geneva, sans-serif" placeholder="" <?= ($responsible) ? '' : 'disabled' ?>>  <?= ($totalRows_rsConclusion > 0) ? $Rows_rsConclusion['appendices'] : "";  ?></textarea>
															<script>
