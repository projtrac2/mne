...
try {
    ...
    if (isset($_GET['proj'])) {
        ...
        $progid = $row_rsProjects['p.progid'];
    ...
    $query_rsOutcomeIndicators = $db->prepare("SELECT * FROM tbl_indicator WHERE indicator_category='OUTCOME' AND indicator_type=2 AND active = '1' AND indicator_dept = '$deptid' ORDER BY indid");
