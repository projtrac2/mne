...
$(document).ready(function() {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "general-settings/selected-items/fetch-selected-tender-type-items",
    order: [], 
    'columnDefs': [{
      'targets': [4],
      'orderable': false,
  ...
  $("#submitItemForm").on("submit", function(event) {
    ...
    if (type && description) {
      ...
      $.ajax({
        url: "general-settings/action/project-tender-type-action",
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "general-settings/selected-items/fetch-selected-tender-type-item",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function(response) {
