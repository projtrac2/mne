...
$(document).ready(function () {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "general-settings/selected-items/fetch-selected-implementation-method-items.php",
    order: [],
    'columnDefs': [{
      'targets': [4],
      'orderable': false,
  ...
  $("#submitItemForm").on("submit", function (event) {
    ...
    if (method && description) {
      ...
      $.ajax({
        url: "general-settings/action/project-implementation-method-action.php",
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "general-settings/selected-items/fetch-selected-implementation-method-item.php",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function (response) {
