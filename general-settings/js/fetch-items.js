...
$(document).ready(function() {
	...
	manageItemTable = $('#manageItemTable').DataTable({
		'ajax': 'general-settings/fetch-items',
		'order': []
	});	
		...
		$('#submitItemForm').on('submit', function(event){
			...
			if(type == "") {
				$("#type").after('<p class="text-danger">Evaluation Type field is required</p>');
				$('#type').closest('.form-input').addClass('has-error');
			}	else {
				// remov error text field
				$("#type").find('.text-danger').remove();
				// success out for form 
				$("#type").closest('.form-input').addClass('has-success');	  	
			}	// /else

			if(description == "") {
				$("#description").after('<p class="text-danger">Evaluation Type Description field is required</p>');
				$('#description').closest('.form-input').addClass('has-error');
			}	else {
				// remov error text field
				$("#description").find('.text-danger').remove();
				// success out for form 
				$("#description").closest('.form-input').addClass('has-success');	  	
			}	// /else
