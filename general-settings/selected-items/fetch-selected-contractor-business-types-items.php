...
$sql = $db->prepare("SELECT * FROM `tbl_contractorbusinesstype` ORDER BY `id` ASC");
$sql->execute();
	...
	while ($row = $sql->fetch()) {
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				...
				<li>
					<a type="button" id="disableBtn" class="disableBtn" onclick="disable('.$itemId.',\''.$type.'\',\''.$wordings.'\')">
