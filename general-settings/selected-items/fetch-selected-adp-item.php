...
try {
    ...
    if ($totalRows_rsProjects > 0) {
        ...
        if (sizeof($implementing_partner) == 0) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> ';
													if ($rows_OutpuprojYear > 0) {
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
															<div class="">
																<h5 class="list-group-item list-group-item-action bg-grey">Output yearly targets distribution </h5>        
															</div>
															<div class="table-responsive">
													...
													if ($disaggregated == 1) {
														...
														if ($totalRows_rs_bendiss > 0) {
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
																<div class="">
																	<h5 class="list-group-item list-group-item-action bg-grey">Output target distribution (Location/s)</h5>        
																</div>
																<div class="table-responsive"> 
																	<table class="table table-bordered table-striped table-hover" id="" style="width:100%">
																		<thead>
