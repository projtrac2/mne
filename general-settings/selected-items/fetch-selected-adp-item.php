...
try {
    ...
    if ($totalRows_rsProjects > 0) {
        ...
        if ($collaborative_partner == 0) {
            $collimplementerarray[] = "Not Applicable";
        } else {
            $projcimplementers = explode(",", $collaborative_partner);
            $r = 0;
        ...
        $partnerCName = implode(",", $collimplementerarray);
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="col-md-12"> 
									<ul class="list-group">  
										...
										<li class="list-group-item"><strong>Implementing Partner : </strong>' . $partnerIName . ' </li>
										<li class="list-group-item"><strong>Collaborative Partner : </strong>' . $partnerCName . '</li> 
									</ul>
								</div>  
                            </div>
                        </div> 
