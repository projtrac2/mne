...
$(document).ready(function() {
  $("#navtitle").addClass("active");  
    ...
    ajax: "general-settings/selected-items/fetch-selected-financial-lines",
    order: [], 
    'columnDefs': [{
      'targets': [4],
      'orderable': false,
  ...
  $("#submitItemForm").on("submit", function(event) {
    ...
    if (name && description ) {
      ...
      $.ajax({
        url: "general-settings/action/project-financial-lines-action",
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "general-settings/selected-items/fetch-selected-financial-line",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function(response) {
