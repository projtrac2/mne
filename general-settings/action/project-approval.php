...
do {
  ...
  $query_projYear = $db->prepare("SELECT * FROM  tbl_project_output_details
    WHERE projid = '$projid' and projoutputid = '$projoutputID' ORDER BY year");
  ...
  $query_rsOpDiss =  $db->prepare("SELECT * FROM tbl_output_disaggregation WHERE outputid = '$projoutputID' ");
