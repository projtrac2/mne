...
try{
	...
	if(isset($_POST["edititem"])){
		...
		$updateQuery = $db->prepare("UPDATE tbl_project_implementation_method SET method=:method, description=:description, status=:status WHERE id=:itemid");
	...
	if(isset($_POST["deleteItem"])){
		...
		$deleteQuery = $db->prepare("DELETE FROM `tbl_project_implementation_method` WHERE id=:itemid");
