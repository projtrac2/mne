...
try{
	...
	if(isset($_POST["edititem"])){
		...
		$updateQuery = $db->prepare("UPDATE tbl_tender_type SET type=:name, description=:description,status=:status WHERE id=:itemid");
	...
	if(isset($_POST["deleteItem"])){
		$itemid = $_POST['itemId'];
		$deleteQuery = $db->prepare("DELETE FROM `tbl_tender_type` WHERE id=:itemid");
