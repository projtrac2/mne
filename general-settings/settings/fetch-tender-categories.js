...
$(document).ready(function () {
  ...
  manageItemTable = $("#manageItemTable").DataTable({
    ajax: "general-settings/selected-items/fetch-selected-tender-categories-items.php",
    order: [],
    'columnDefs': [{
      'targets': [4],
      'orderable': false,
  ...
  $("#submitItemForm").on("submit", function (event) {
    ...
    if (name && description) {
      ...
      $.ajax({
        url: "general-settings/action/project-tender-categories-action.php",
...
function editItem(itemId = null) {
  if (itemId) {
    ...
    $.ajax({
      url: "general-settings/selected-items/fetch-selected-tender-categories-item.php",
      type: "post",
      data: { itemId: itemId },
      dataType: "json",
      success: function (response) {
