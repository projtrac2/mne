                        ...
                        <tr>
                            <td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
                                <div align="left" style="vertical-align: text-bottom">
                                    <font size="3" color="#FFF"><i class="fa fa-id-card-o" aria-hidden="true"></i></font>
                                    <font size="3" color="#FFC107"><strong>User Titles</strong></font>
                            </td>
                            <td width="20%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
                                <button type="button" id="modal_button" class="pull-right btn bg-deep-purple" data-toggle="modal" id="addItemModalBtn" data-target="#addItemModal"> <i class="fa fa-plus-square"></i> Add Title</button>
                </div>
                </td>
                </tr>
                </table>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="body">
                                    <div class="div-result">
                                        <form class="form-horizontal" id="editItemForm" action="project-titles-action.php" method="POST">
                                            <br />
    ...
    <script src="assets/js/settings/titles/fetch-titles-items.js"></script>