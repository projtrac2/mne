...
if ($permission) {
  $pageTitle = "Add Monitoring Checklist";
  try {
      ...
      $query_rsOutputs = $db->prepare("SELECT p.output as  output, o.id as opid, p.indicator
      FROM tbl_project_details o INNER JOIN tbl_progdetails p ON p.id = o.outputid WHERE projid='$projid' ");
         ...
         <div class="block-header bg-blue-grey" width="100%" height="55" style="margin-top:10px; padding-top:5px; padding-bottom:5px; padding-left:15px; color:#FFF">
            <h4 class="contentheader">
               ...
               <div class="btn-group" style="float:right">
                  <div class="btn-group" style="float:right">
                    <button  class="btn btn-warning pull-right" onclick="exit()" id="nextT" type="button">After adding checklist click here to proceed</button>
