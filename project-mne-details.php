...
try {
	...
	if ($permission) {
		...
		$proj_array = explode("projid54321", $decode_proj);
		$projid = $proj_array[1];
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="header" style="padding-bottom:0px">
								<div class="" style="margin-top:-15px">
									...
									<a href="#" class="btn bg-grey waves-effect" style="margin-top:10px; width:100px"> M&E </a>
							...
							<h4>
								<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="font-size:15px; background-color:#CDDC39; border:#CDDC39 thin solid; border-radius:5px; margin-bottom:2px; height:25px; padding-top:2px; vertical-align:center">
									Project Name: <font color="white"><?php echo $project; ?></font>
								</div>
																				...
																				<tbody>
																					...
																					if ($total_Output > 0) {
																						...
																						while ($row_rsOutput = $query_Output->fetch()) {
																							...
																							$indid = base64_encode("indid54321{$indid}");
																							$indicator_name = $row_rsOutput['indicator_name'];
																				...
																				<tbody>
																					...
																					?>
																						...
																						foreach ($projlocations as $locations) {
																							...
																							if ($calculation_method == 2 && $total_baseline_denominator > 0) {
