...
if ($permission) {
	$decode_kra = (isset($_GET['kra']) && !empty($_GET["kra"])) ? base64_decode($_GET['kra']) : header("Location: view-strategic-plans.php");
			...
			if ($resultObjectives) {
				...
				if (isset($_POST['add'])) {
					$results = "<script type=\"text/javascript\">
                        ...
                        setTimeout(function(){
                            window.location.href = 'add-objective.php?kra=$original_kraid';
                        }, 3000);
                    </script>";
					echo $results;
