					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:-5px">
						<tr>
							<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
								<div align="left" style="vertical-align: text-bottom"><font size="3" color="#FFF"><i class="fa fa-clock-o" aria-hidden="true"></i></font> <font size="3" color="#FFC107"><strong>Data Collection Frequency</strong></font>
							</td>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="body">
                                    ...
                                    <div class="col-md-12 form-input">
                                        <label>
                                            <font color="#174082">Data Collection Frequency: </font>
                                        </label>
                                        <input type="text" class="form-control" id="frequency" placeholder="Data Collection Frequency" name="frequency" required autocomplete="off">
                                    </div>
                                    <div class="col-md-12 form-input">
                                        <label>
                                            <font color="#174082"> Days: </font>
                                        </label>
                                        <input type="text" class="form-control" id="days" placeholder="Days" name="days" required autocomplete="off">
                                    </div>
                                    <!-- /form-group-->
                                </div>
                            </div>
...
<div class="modal fade" id="editItemModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#03A9F4">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="color:#fff" align="center"><i class="fa fa-edit"></i> Edit Data Collection Frequency</h4>
            </div>
                            ...
                            <div class="body">
                                <div class="div-result">
                                    ...
                                    <div class="col-md-12 form-input">
                                        ...
                                        <input type="text" class="form-control" id="editfrequency" placeholder="Data Collection Frequency" name="editfrequency" required autocomplete="off">
                                    </div>
                                    <div class="col-md-8 form-input">
                                        ...
                                        <div class="modal-footer editItemFooter">
                                            <div class="col-md-12 text-center">
                                                ...
                                                <input type="hidden" name="createdby" value="10">
                                                <button type="button" class="btn btn-warning waves-effect waves-light" data-dismiss="modal"> Cancel</button>
                                                <input name="save" type="submit" class="btn btn-primary waves-effect waves-light" id="tag-form-submit" value="Save" />
                                            </div>
                                        </div> <!-- /modal-footer -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeItemModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#03A9F4">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="color:#fff" align="center"><i class="glyphicon glyphicon-trash"></i> Delete Data Collection Frequency</h4>
            </div>
            <div class="modal-body">
