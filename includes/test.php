								...
								<div id="menu2" class="tab-pane fade">
									...
									<script>
										...
										function create_chart(series) {
											return Highcharts.ganttChart('container-gantt', {
												title: {
										...
										$(document).ready(function() {
											chart = create_chart(<?= $project_data ?>);
										});
										...
										function get_data() {
											...
											$.ajax({
												type: "get",
												url: "ajax/programsOfWorks/ganttchart",
												data: {
												...
												success: function(response) {
													if (response.success) {
														...
														// chart = create_chart([{
														// 	name: 'Kapseret Road Works',
														// 	data: [{
														// 		id: 'output_16',
														// 		name: 'New Bridges Constructed ',
														// 		start: 1700784000000,
														// 		end: 1710460800000,
														// 	}, {
														// 		id: 'task_27',
