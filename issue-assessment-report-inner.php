				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:-3px">
					<tr>
						<td width="50%" style="float:right; font-size:11px" align="right">
							<div class="btn-group" style="margin-top:3px; margin-right:10px">
								<a href="project-escalated-issue?issueid=<?=$issueid?>" class="btn btn-warning"  style="height:27px; ; margin-top:-1px; vertical-align:center">Go Back</a>
							</div>				
