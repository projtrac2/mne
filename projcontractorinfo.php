    ...
    <section class="content" style="margin-top:-20px; padding-bottom:0px">
        <div class="container-fluid">
            <div class="block-header">
                <h4 class="contentheader"><i class="fa fa-address-card" aria-hidden="true"></i> Contractor Details
                    <a href="contractorslist" type="button" class="btn bg-orange waves-effect" style="float:right; margin-top:-5px">Go Back to Contractors</a>
                </h4>
            </div>
            <!-- Draggable Handles -->
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <!-- <div class="body"> -->
                        <?php
                        include_once('projcontractorinfo-inner.php');
                        ?>
                        <!--</div> -->
                    </div>
                </div>
