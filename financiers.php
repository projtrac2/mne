...
try{
	...
	if (isset($_GET["del"]) && isset($_GET['fn'])) {
		...
		$deleteSQL = $db->prepare("DELETE FROM tbl_financiers WHERE id=:fnid");										  
        $Result1 = $deleteSQL->execute(array(":fnid" => $fnid));

		if($Result1){
			$msg = 'Financier successfully deleted.';
	...
	$query_rsfinancier = $db->prepare("SELECT *, f.id as fnid, t.type as ftype FROM tbl_financiers f inner join tbl_financier_type t ON t.id=f.type ORDER BY f.id ASC");
    ...
    <section class="content" style="margin-top:-20px; padding-bottom:0px">
        <div class="container-fluid">
            <div class="block-header bg-blue-grey" width="100%" height="55" style="margin-top:10px; padding-top:5px; padding-bottom:5px; padding-left:15px; color:#FFF">
				<h4 class="contentheader"><i class="fa fa-slideshare" aria-hidden="true"></i> Financial Partners</h4>
            </div>
            <!-- Draggable Handles -->
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <!-- <div class="body"> -->
							<?php
							include_once('financiers-inner.php');
							?>
						<!--</div> -->
                    </div>
                </div>
