...
<head>
    ...
    <title>Result-Based Monitoring &amp; Evaluation System: Escalated Project Issues</title>
    <!-- Favicon-->
    ...
    <section class="content" style="margin-top:-20px; padding-bottom:0px">
        <div class="container-fluid">
            <div class="block-header">          
				<h4>
				<div class="col-md-12" style="background-color:#F7F7F7; border:#F7F7F7 thin solid; border-radius:2px; margin-bottom:5px; height:25px"><i class="fa fa-police" aria-hidden="true"></i> Project Escalated Issues</div>       
			...
			<div class="row clearfix" style="margin-top:10px">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px">
					<div class="card">
						<div class="header" style="padding-bottom:0px">
                            <div class="button-demo" style="margin-top:-15px">
								...
								<a href="myprojectmilestones?projid=<?php echo $prjid; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Activities</a>
								<a href="myprojectworkplan?projid=<?php echo $prjid; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Work Plan</a>
								<a href="myprojectfinancialplan?projid=<?php echo $prjid; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Financial Plan</a>
								<a href="myproject-key-stakeholders?projid=<?php echo $prjid; ?>" class="btn bg-light-blue waves-effect" style="margin-top:10px; margin-left:-9px">Key Stakeholders</a>
                    ...
                    <div class="card">
                        <!-- <div class="body"> -->
							<?php
							include_once('project-escalated-issues-inner.php');
							?>
						<!--</div> -->
                    </div>
                </div>
