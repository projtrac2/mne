 ...
 */
$stmt_project_roles = $db->prepare('SELECT * FROM tbl_project_team_roles');
                    ...
                    <tr>
                        <td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
                            <div align="left" style="vertical-align: text-bottom">
                                ...
                                <font size="3" color="#FFC107"><strong>Project Roles</strong></font>
                            </div>
                        </td>
                        <td width="20%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
                            <button type="button" id="modal_button" class="pull-right btn bg-deep-purple" data-toggle="modal" id="addItemModal" data-target="#addItemModal"> <i class="fa fa-plus-square"></i> Add Project Role</button>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="width:35%"><?= $role->description ?></td>
                                <td style="width:15%"><?= $role->rank ?></td>
        ...
        <div class="modal-content">
            <form class="form-horizontal" id="submitItemForm" action="general-settings/action/project-priorities-action.php" method="POST" enctype="multipart/form-data">
                <div class="modal-header" style="background-color:#03A9F4">
                    ...
                    <h4 class="modal-title" style="color:#fff" align="center"><i class="fa fa-plus"></i> Add Project Team Role</h4>
                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="body">
                                    ...
                                    <div class="col-md-12 form-input">
                                        ...
                                        <input type="text" class="form-control name_add" id="name" placeholder="Line name" name="name" required autocomplete="off">
                                    ...
                                    <div class="col-md-12 form-input" style="margin-top:10px">
                                        ...
                                        <textarea class="form-control description_add" id="description" placeholder="Line description" name="description" required autocomplete="off" required></textarea>
                                        <span class="description_error text-danger"></span>
                                    </div> <!-- /form-group-->

                                    <div class="col-md-12 form-input">
                                        <label>
                                            <font color="#174082">Rank</font>
                                        </label>
                                        <select name="rank" class="form-control rank_add">
                                            <option value="select...">Select...</option>
                                            <?php foreach ($ranks as $key => $rk) { ?>
                                                <option value="<?= $key ?>"><?= $rk ?></option>
                                            <?php } ?>
                                        </select>
                                        <span class="rank_error text-danger"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="col-md-12 form-input" style="margin-top:10px">
                                            ...
                                            <textarea class="form-control description" id="description" placeholder="Line description" name="description" required autocomplete="off" required><?= $role->description ?></textarea>
                                        </div> <!-- /form-group-->
                                        ...
                                        <div class="col-md-12 form-input">
                                            ...
                                            <select name="rank" class="form-control rank">
                                                <option value="select...">Select...</option>
                                                <?php foreach ($ranks as $key => $rk) { ?>
                                                    <option <?php if ($role->rank == $key) { ?> selected <?php } ?> value="<?= $key ?>"><?= $rk ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    $('.save-new-btn').on('click', (e) => {
        ...
        $.ajax({
            url: 'general-settings/action/project-team-roles-action.php',
            type: 'post',
            data: data,
            processData: false,
            cache: false,
