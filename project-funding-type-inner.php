    					...
    					<tr>
    						<td width="80%" height="35" style="padding-left:5px; background-color:#607D8B; color:#FFF">
    							<div align="left" style="vertical-align: text-bottom">
    								<font size="3" color="#FFF"><i class="fa fa-money" aria-hidden="true"></i></font>
    								<font size="3" color="#FFC107"><strong>Project Funding Type</strong></font>
    						</td>
    							...
    							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    								<div class="body">
    									...
    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Funding Type: </font>
    										</label>
    									...
    									<div class="col-md-12 form-input">
    										<label>
    											<font color="#174082">Funding Type Description: </font>
    										</label>
