                ...
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                    ...
                    <tbody>
						...
						{ 
							...
							<tr style="background-color:#eff9ca">
								<td style="width:3%" align="center"><?php echo $nm; ?></td>
								<td style="width:27%"><span width="16" height="16" style="color:blue" data-toggle="tooltip" data-placement="bottom" title="<?php if($limittype==1){ echo "Start Date: ".date("d M Y",strtotime($svystartdate))."; End Date: ".date("d M Y",strtotime($svyenddate)); } else { echo "Required Responses: ".$responsesnumber; }?>"><?php echo $formname; ?></span></td>
                    ...
                    <tbody>
						...
						{ 
							...
							<tr style="background-color:#eff9ca">
								...
								<td style="width:10%" align="center"><span class="badge bg-purple" style="margin-bottom:2px" width="16" height="16" data-toggle="tooltip" data-placement="bottom" title="<?php if($limittype==1){ echo "Survey Start Date: ".date("d M Y",strtotime($svystartdate))."; Survey End Date: ".date("d M Y",strtotime($svyenddate)); } else { echo "Survey Required Responses: ".$responsesnumber; }?>"><?=$count_survey?></span></td>
								<td style="width:10%">
									<div align="center">
