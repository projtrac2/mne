        ...
        <div class="card">
            <div class="header">
                <div class="block-header" width="100%" height="55" style="margin-top:10px; padding-top:5px; padding-bottom:5px; padding-left:15px; background-color:#607D8B; color:#FFF">
                    <h4 class="contentheader"><i class="fa fa-arrows" aria-hidden="true"></i> Projects Financiers Report
                    </h4>
                </div>
            </div>
            <div class="body">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="manageItemTable">
                        <thead>
                            <tr>
                                ...
                                <th width="13%">Project Financier</th> 
...
<script src="assets/custom js/fetch-projects-financiers-report.js"></script>